...
dat_medians <- readRDS("Data/04_dat_medians.rds") %>%
...
dat_raw <- readRDS("Data/03_dat_7.rds")
...
if (save_ordinary_regression){
  saveRDS(result_ols_incl_data, "Data/05_result_ols_incl_data.rds")
  saveRDS(result_ols, "Data/05_result_ols.rds")
}
...
# Save gg_with_eqs 
ggsave("Figures/05_HG_North_Sea_Southwest_with_eqs.png", gg_with_eqs, 
...
if (overwrite_saved_regression){
  ...
  saveRDS(dat_series_trend, "Data/05_dat_series_trend.rds")
