...
if (FALSE){
  ...
  # for app
  file.copy("Data/05_dat_status_trend_2024.rds", 
...
### SAVE ### 
# saveRDS(meta_status_region, "Data/06_meta_status_region_2024.rds")
...
if (TRUE){
  ...
  ggsave("Figures/Relative_class_CB118_by_MSFDregion2_2024.png", gg2, width = 9.5, height = 5, dpi = 400)
...
plotdata_boxplot %>%
  as.data.frame() %>%
  writexl::write_xlsx("Figures/2024/PCB118_by_MSFDregion_boxplot_fromR_2024.xlsx")
...
dd_points %>%
  as.data.frame() %>%
  writexl::write_xlsx("Figures/2024/PCB118_by_MSFDregion_dots_fromR_2024.xlsx")
