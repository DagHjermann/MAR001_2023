...
dir("Data", "07_dat_status_trend_2025")
...
#
meta_trends_region <- readRDS("Data/06_meta_trends_region_2025.rds")
...
write.csv(dat_status_trend, "Submitted_to_EEA/2025/MAR001_map_data_points.csv")  
...
writeLines(
  ...
  "Submitted_to_EEA/2025/MAR001_map_data_points_info.csv")  
...
unique(trend_by_region_meta$overall_trend) %>% dput()
...
writexl::write_xlsx(data_list, "Submitted_to_EEA/2025/MAR001_DataPackageFig1_before_edit.xlsx")
...
ggplot(trend_by_region_meta, aes(x = Region, y = Change_perc_10yr)) +
  geom_pointrange(aes(ymin = Change_perc_10yr_lo, ymax = Change_perc_10yr_up, color = overall_trend )) +
